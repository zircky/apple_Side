    ...
    return (
        <footer className="bg-[#9ca3af]">
                ...
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link href="/" className="flex items-center">
                            <img src='/images/logo.svg' className="h-8 mr-3"
                                 alt="FlowBite Logo"/>
                        </Link>
                    </div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <Link href="/catalog/iPhone"
                                       className="hover:underline ">iPhone</Link>
                                </li>
                                <li>
                                    <Link href="/catalog/ipad" className="hover:underline">iPad</Link>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <Link href="/catalog/applewatch" className="hover:underline">AppleWatch</Link>
                                </li>
                                <li>
                                    <Link href="/catalog/mac" className="hover:underline">Mac</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
          ...
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link
              href="/" className="hover:underline">QPICK</Link>. All Rights Reserved.
          </span>
