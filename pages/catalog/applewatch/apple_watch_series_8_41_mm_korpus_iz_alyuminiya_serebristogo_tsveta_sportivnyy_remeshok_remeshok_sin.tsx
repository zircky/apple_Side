...
import apple_watch_series_8_41_mm_korpus_iz_alyuminiya_serebristogo_tsveta_sportivnyy_remeshok_remeshok_sin1 from '@/assets/products/applewatch/apple_watch_series_8_41_mm_korpus_iz_alyuminiya_serebristogo_tsveta_sportivnyy_remeshok_remeshok_sin.webp'
import Image from "next/image";
import Layout from "@/layout/Layout";

const product = {
    name: 'Apple Watch Series 8, 41 мм, корпус из алюминия серебристого цвета, спортивный ремешок ремешок синий омут',
    price: '399$',
    href: '#',
    breadcrumbs: [
        { id: 1, name: 'Home', href: '/' },
        { id: 2, name: 'Apple Watch', href: '/catalog/applewatch' },
    ],
    images: [
        {
...
const apple_watch_series_8_41_mm_korpus_iz_alyuminiya_serebristogo_tsveta_sportivnyy_remeshok_remeshok_sin: FC = () => {
                ...
                <div className="pt-6">
                    ...
                    <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
                        <div className="aspect-w-3 aspect-h-4 hidden overflow-hidden rounded-lg lg:block">
                            <Image src={apple_watch_series_8_41_mm_korpus_iz_alyuminiya_serebristogo_tsveta_sportivnyy_remeshok_remeshok_sin1} alt='1'
...
export default apple_watch_series_8_41_mm_korpus_iz_alyuminiya_serebristogo_tsveta_sportivnyy_remeshok_remeshok_sin